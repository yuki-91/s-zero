...
SOUNDPARAM g_aParam[SOUND_LABEL_MAX] =
{
	...
	{ "data/sound/itembox.wav", 0 },			// アイテムボックス
	{ "data/sound/wahaa.wav", 0 },			// ワッハー
	{ "data/sound/strange_wave.wav", 0 },			// キノコ
	{ "data/sound/シューン.wav", 0 },			// ターボ
	{ "data/sound/startmae.wav", 40 },			// エンジン
	{ "data/sound/drift_se.wav", 0 },			// ドリフト
};
