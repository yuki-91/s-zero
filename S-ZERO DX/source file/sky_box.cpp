...
LPDIRECT3DTEXTURE9 CXmodel::m_pTextures;//テクスチャ
LPD3DXMESH  CXmodel::m_pMesh;			//メッシュ
DWORD  CXmodel::m_nMaterialNum;			//マテリアル数
LPD3DXBUFFER  CXmodel::m_pMaterials;	//マテリアル
D3DXMATRIX  CXmodel::m_mtxScale;		//拡大縮小
D3DXMATRIX  CXmodel::m_World;			//ワールドマトリックス
D3DXVECTOR3  CXmodel::m_Position;		//位置
LPDIRECT3DDEVICE9  CXmodel::m_Device;	//デバイス
