...
bool CJump_Reverse::Initjump()
{
	...
	g_TransPos3[2] = D3DXVECTOR3(40.0f, 1.2f, 45.0f);
...
void CJump_Reverse::VertexBuffer_Field()
{
	...
	VERTEX_BILLBOARD b[] =
	{
		{ D3DXVECTOR3(-1, 0.1, 3),D3DCOLOR_RGBA(255, 255, 255, 255),D3DXVECTOR2(0, 0) },
		{ D3DXVECTOR3(1, 0.1, 3),D3DCOLOR_RGBA(255, 255, 255, 255),D3DXVECTOR2(1, 0) },
		{ D3DXVECTOR3(-1, 0.7,-3),D3DCOLOR_RGBA(255, 255, 255, 255),D3DXVECTOR2(0, 1) },
		{ D3DXVECTOR3(1, 0.7, -3),D3DCOLOR_RGBA(255, 255, 255, 255),D3DXVECTOR2(1, 1) },
	};
