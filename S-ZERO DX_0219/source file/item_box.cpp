...
bool CItem::InitItem()
{
	...
	g_TransPosI[0] = D3DXVECTOR3(0.0f, 1.1f, 77.0f);
	g_TransPosI[1] = D3DXVECTOR3(5.0f, 1.1f, 77.0f);
	g_TransPosI[2] = D3DXVECTOR3(-5.0f, 1.1f, 77.0f);

	g_TransPosI[3] = D3DXVECTOR3(-130.0f, 1.1f, 37.0f);
	g_TransPosI[4] = D3DXVECTOR3(-135.0f, 1.1f, 37.0f);
	g_TransPosI[5] = D3DXVECTOR3(-125.0f, 1.1f, 37.0f);

	g_TransPosI[6] = D3DXVECTOR3(130.0f, 1.1f, -57.0f);
	g_TransPosI[7] = D3DXVECTOR3(135.0f, 1.1f, -57.0f);
	g_TransPosI[8] = D3DXVECTOR3(125.0f, 1.1f, -57.0f);

	g_TransPosI[9] = D3DXVECTOR3(0.0f, 1.1f, -130.0f);
	g_TransPosI[10] = D3DXVECTOR3(0.0f, 1.1f, -135.0f);
	g_TransPosI[11] = D3DXVECTOR3(0.0f, 1.1f, -125.0f);
